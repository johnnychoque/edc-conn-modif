...
public class NegotiationEventExtension implements ServiceExtension {
    @Inject
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        eventRouter.registerSync(Event.class, new AgreementReached(httpClient)); // synchronous dispatch
    }
}
